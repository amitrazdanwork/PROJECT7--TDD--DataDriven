...
public class ReportUtil extends CommonUtils {
	...
	public void Suite_StartUp() {
		...
		// Dynamic report name generation with time-stamp

		reportName = new SimpleDateFormat("dd-MM-yyy_hh.mm.ss").format(new Date()); // returns date with time i.e.
																					// timestamp

		reporter = new ExtentSparkReporter(
				"C:\\Users\\razda\\git\\PROJECT3\\Reports\\" + reportName + ".html");
	...
	public void Suite_TearDown() throws IOException {
		...
		Desktop.getDesktop().browse(
				new File("C:\\Users\\razda\\git\\PROJECT3\\Reports\\" + reportName + ".html")
						.toURI());
